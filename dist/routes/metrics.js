...
import { getRecentMetrics, getAggregatedStats, getSuspiciousRequests, getRequestsByIP, } from '../middleware/metrics.js';
/**
 ...
 */
export function createMetricsRoutes(options) {
